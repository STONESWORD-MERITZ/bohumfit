...
DISCLOSURE_DISCLAIMER = (
    "BOHUMFIT 결과는 업로드한 진료자료를 바탕으로 AI가 산출한 참고용 보조자료이며, 의학적 진단이나 "
    "보험 가입·인수·보험금 지급 여부를 확정하지 않습니다. 실제 알릴의무(고지) 대상과 범위는 보험사별 "
    "청약서 문항·약관·인수지침에 따라 달라질 수 있으므로, 청약 전 반드시 해당 청약서 문항과 대조해 "
    "주세요. 고지 누락에 대한 최종 책임은 청약자 본인에게 있으며, 본 서비스는 분석 결과의 사용으로 "
    "인한 법적 책임을 지지 않습니다."
)

INSURANCE_DISCLAIMER = (
    "추정값입니다. 정확한 보험금·환급금 지급 여부와 금액은 보험사 약관·심사 및 국민건강보험공단 "
    "확인이 필요합니다. 본 안내는 보험 모집·중개·상품추천·가입권유를 목적으로 하지 않습니다."
)
