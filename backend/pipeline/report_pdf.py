...
DISCLOSURE_DISCLAIMER = (
    ...
    # BOHUMFIT-157: 171b 분석 히스토리(자동 기록 7일·저장 90일) 도입에 맞춰 "저장하지 않음" 단정 정합화(문구만).
    "대조해 주세요. 본 서비스는 이용자가 직접 관리·삭제할 수 있는 분석 히스토리(최근 자동 기록 7일·저장 90일) "
    "외에는 분석 결과를 보관하지 않으며, 출력물은 고객 본인이 보유·관리합니다. 고지 누락에 "
...
INSURANCE_DISCLAIMER = (
    ...
    # BOHUMFIT-157: 171b 분석 히스토리 도입 정합(문구만).
    "이용자가 직접 관리·삭제할 수 있는 분석 히스토리 외에는 분석 결과를 보관하지 않고 출력물은 고객 본인이 보유합니다."
)
