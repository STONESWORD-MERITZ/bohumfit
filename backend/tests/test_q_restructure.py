"""BOHUMFIT-009: 신구조 Q1~Q4 함수 + _split_buckets 회귀 테스트.
...
def test_summary_reports_remove_q2_suspicion_only_review_questions():
    """BOHUMFIT-168: ???????? ?? ?? Q2 ??? ???? ????."""
    ds = {
        "K21": _disease(code="K21", name="??????", visits=["2026-04-15"], first="2026-04-15"),
        "M33": _disease(code="M33", name="???", visits=["2025-08-15"], first="2025-08-15"),
    }
    health_items = [{
        "date": "2025-08-15",
        "code": "M33",
