...
KB_COVERAGES: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("간병인/간호간병상해일당", "치매/간병", "입원일당", AGG_SUM),
    ("간병인/간호간병질병일당", "치매/간병", "입원일당", AGG_SUM),
    ("일반암", "암 진단", "암", AGG_SUM),
    ("유사암", "암 진단", "암", AGG_SUM),
    ("고액암", "암 진단", "암", AGG_SUM),
