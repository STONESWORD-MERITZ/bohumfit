...
const sections: Section[] = [
  ...
  },
  {
    ...
    body: [
      ...
      // BOHUMFIT-265: 오프라인 열람용 기기 내 임시 보관(A안) 고지. ★기존 조항은 그대로 두고 한 문단만 추가한다.
      "오프라인 열람용 기기 내 임시 보관: 최근 분석 5건이 이용자 기기(브라우저 저장소)에 24시간 동안 임시 보관되며, 24시간이 지나면 자동 삭제되고 로그아웃 시 즉시 삭제됩니다. 이 정보는 이용자 기기에만 저장되고 서비스 서버로 전송되지 않습니다.",
