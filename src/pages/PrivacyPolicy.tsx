...
const sections: Section[] = [
  ...
  },
  {
    ...
    body: [
      ...
      // BOHUMFIT-279: 265 오프라인 캐시 A안 **철회**(Human 확정). 배선되지 않은 "최근 5건·24시간" 고지를
      //   실제 동작으로 교체한다 — 실제로는 다시 보기용으로 **브라우저 세션 저장소에 10분** 보관한다(277 기준).
      //   ★법적 고지다. 실제보다 넓게도 좁게도 쓰지 않는다.
      "다시 보기용 기기 내 임시 보관: 분석 직후 결과를 이용자 기기의 브라우저 세션 저장소에 10분 동안 임시 보관하며, 10분이 지나면 자동 삭제됩니다. 로그아웃·다른 계정 로그인 시 즉시 삭제되고, 브라우저 탭을 닫으면 함께 사라집니다. 이 정보는 이용자 기기에만 저장되고 서비스 서버로 별도 전송되지 않습니다.",
