...
- `npm test` — 기준선 `419 passed / 43 files`(BOHUMFIT-303 Codex 2차 실측·2026-08-22, 라우트 스모크 18건 포함)
- `cd backend && python -m pytest -q` — 기준선 `1102 passed, 8 skipped` (BOHUMFIT-303 Codex 2차 실측·2026-08-22.
