...
- `npm test` — 기준선 `402 passed / 41 files`(BOHUMFIT-284 실측·2026-08-10, 라우트 스모크 18건 포함)
- `cd backend && python -m pytest -q` — 기준선 `1044 passed, 8 skipped` (BOHUMFIT-293 1차 실측·2026-08-18 · Codex 확정 대기.
