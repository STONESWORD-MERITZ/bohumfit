...
- `npm test` — 기준선 `373 passed / 38 files`(BOHUMFIT-277b 실측·2026-08-08, 라우트 스모크 18건 포함)
- `cd backend && python -m pytest -q` — 기준선 `890 passed, 8 skipped` (BOHUMFIT-277b 실측·2026-08-08.
