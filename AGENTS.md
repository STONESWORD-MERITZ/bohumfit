...
- `npm test` — 기준선 `342 passed / 35 files`(BOHUMFIT-273 실측·2026-08-06, 라우트 스모크 18건 포함)
- `cd backend && python -m pytest -q` — 기준선 `861 passed, 8 skipped` (BOHUMFIT-276b 실측·2026-08-06.
