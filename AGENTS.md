...
- `npm test` — 기준선 `393 passed / 40 files`(BOHUMFIT-279 실측·2026-08-08, 라우트 스모크 18건 포함)
- `cd backend && python -m pytest -q` — 기준선 `902 passed, 8 skipped` (BOHUMFIT-276c 실측·2026-08-08.
