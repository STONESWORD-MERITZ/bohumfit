...
- `npm test` — 기준선 `406 passed / 41 files`(BOHUMFIT-294 Codex 2차 실측·2026-08-18, 라우트 스모크 18건 포함)
- `cd backend && python -m pytest -q` — 기준선 `1052 passed, 8 skipped` (BOHUMFIT-294 Codex 2차 실측·2026-08-18.
