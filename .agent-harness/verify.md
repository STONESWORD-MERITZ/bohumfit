...
## 검증 기준선 (BOHUMFIT-296/296b Codex 2차 실측 · 2026-08-18 갱신)

백엔드 pytest — `cd backend && python -m pytest -q`:

```text
1065 passed, 8 skipped
```

(BOHUMFIT-296/296b Codex 2차 실측·2026-08-18 — 295/295b 기준선 1058/8에 52행·N대수술비 max·이관/헤더 제거 계약 7건을 더해 1065/8.
...
| overview(합계-only) | 239 fallback(매트릭스 부재) | `보장분석\비교분석표\라*실INPUT.pdf` | 15 | 59/42 | 1,500,690,000 | 4,675,189 (4,675,189) | 25 | 1 |
