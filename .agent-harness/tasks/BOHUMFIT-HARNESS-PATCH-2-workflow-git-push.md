# BOHUMFIT-HARNESS-PATCH-2: 워크플로우 문서 — Codex git push 담당 반영

## 목적
BOHUMFIT-002부터 적용된 워크플로우 변경(검증 통과 후 git 커밋·푸시까지 Codex 담당)을
...
## 비고
- BOHUMFIT-002 Codex 턴부터 이미 적용 중 — 소급 변경 아닌 문서화 작업
- 이후 모든 태스크에 적용
