# BOHUMFIT-LAUNCH-002: BOHUMFIT.ai 정식 오픈 전 신뢰도 정리
...
- Replace old `bohumfit-react.vercel.app` OG exposure with `bohumfit.ai`.
...
- Commit message: `BOHUMFIT-LAUNCH-002: BOHUMFIT.ai 정식 오픈 전 법적 placeholder + 공개 신뢰도 정리`
