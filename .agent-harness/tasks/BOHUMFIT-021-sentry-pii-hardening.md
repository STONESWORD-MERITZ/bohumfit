# BOHUMFIT-021: Sentry PII hardening
...
## Context
- BOHUMFIT-020 found that `sentry-sdk==2.60.0` defaults `include_local_variables` to `True`.
...
## Scope
- `backend/main.py`
- `.agent-harness/tasks/BOHUMFIT-021-sentry-pii-hardening.md`
