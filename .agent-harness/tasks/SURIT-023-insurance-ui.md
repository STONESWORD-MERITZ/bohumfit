# SURIT-023 — 실손 청구 안내 2단계: §4-2 확정 반영 + 계산 보정 + UI 통합

- Owner: Cowork (구현) → 검증·푸시 Codex
- 기준 문서: `.agent-harness/docs/BOHUMFIT_실비기능_설계_v3.md` (v3-1)
- 생성: 2026-06-06
- 전제: SURIT-022 1단계 완료(상수+계산 모듈+데이터 진단).
...
- `.agent-harness/docs/BOHUMFIT_실비기능_설계_v3.md`, `.agent-harness/tasks/SURIT-023-insurance-ui.md`
