# BOHUMFIT-028 — 실손 최소공제 + 의원 자동분류 (기존 실손에 additive)

- Owner: Cowork (구현) → 검증·푸시 Codex
- 기준: `.agent-harness/docs/BOHUMFIT_실비기능_설계_v4.md` (§4-4/4-5/6-1~6-4)
- 생성: 2026-06-08
- 전제: BOHUMFIT-022/023/025 실손 기능. 본 작업은 additive — 기존 ①②③ 불변.
...
- `.agent-harness/docs/BOHUMFIT_실비기능_설계_v4.md`, `.agent-harness/tasks/BOHUMFIT-028-min-deductible.md`
